...
$(".sMenu").click(function () {
  isTrue
    ? ($(".tabMenu").addClass(" gOpen ").removeClass(" gClose "),
      ...
      (isTrue = !isTrue))
    : ($(".tabMenu").addClass(" gClose ").removeClass(" gOpen "),
      $(".fa-align-justify").toggleClass("fa-times"),
      $(".navBar").css("left", 0),
      $(".tabMenu li").animate(
        {
...
$(".strip-search").click(function () {
  isSearchTrue
    ? ($(".search").addClass(" gOpen ").removeClass(" gSearch "),
    ...
    : ($(".search").addClass(" gSearch ").removeClass(" gOpen "),
      $(".fa-search").toggleClass("fa-times"),
      $(".searchInput").animate({
        top: "300%",
      }),
...
$(document).scroll((e) => {
  if ($(document).scrollTop()) {
    $(".posation3").css("backgroundColor", "#0D0D0D");
  }
});
